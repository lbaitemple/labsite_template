...
title: "Software"
layout: default
excerpt: "Lab Software and Tools"
sitemap: false
permalink: /software/
---
...
<div class="col-sm-12">
  <h1>Software</h1>
  <p>Our lab develops and maintains several open-source software tools and libraries for the research community.</p>
</div>
      ...
      <div class="panel panel-default" style="height: 100%;">
        <div class="panel-body">
          ...
          <div style="text-align: center; margin-top: 15px;">
            <a href="https://github.com/yourusername/project1" class="btn btn-primary" target="_blank">
    ...
    <div class="col-sm-6">
      <div class="panel panel-default" style="height: 100%;">
        <div class="panel-body">
          ...
          <div style="text-align: center; margin-top: 15px;">
            <a href="https://github.com/yourusername/project2" class="btn btn-primary" target="_blank">
              <span class="glyphicon glyphicon-download-alt"></span> GitHub
            </a>
            <a href="#" class="btn btn-info" target="_blank">
              <span class="glyphicon glyphicon-book"></span> Documentation
    ...
    <div class="col-sm-6">
      <div class="panel panel-default" style="height: 100%;">
        <div class="panel-body">
          ...
          <div style="text-align: center; margin-top: 15px;">
            <a href="https://github.com/yourusername/project3" class="btn btn-primary" target="_blank">
              <span class="glyphicon glyphicon-download-alt"></span> GitHub
            </a>
            <a href="#" class="btn btn-info" target="_blank">
              <span class="glyphicon glyphicon-book"></span> Documentation
    ...
    <div class="col-sm-6">
      <div class="panel panel-default" style="height: 100%;">
        <div class="panel-body">
          ...
          <div style="text-align: center; margin-top: 15px;">
            <a href="https://github.com/yourusername/project4" class="btn btn-primary" target="_blank">
              <span class="glyphicon glyphicon-download-alt"></span> GitHub
            </a>
            <a href="#" class="btn btn-info" target="_blank">
              <span class="glyphicon glyphicon-book"></span> Documentation
